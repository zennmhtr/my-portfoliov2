  ...
  return (
    <div className="relative min-h-[100dvh] flex items-center justify-center">
      ...
      >
        ...
        >
          {[
            { href: "https://github.com/zennmhtr",      icon: "skill-icons:github-dark",    label: "GitHub",    color: "hover:text-green-600" },
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-2 bg-green-50/80 dark:bg-green-900/20 border border-green-200/50 dark:border-green-800/50 rounded-full backdrop-blur-sm mb-6"
        >
          <motion.div
        ...
        {/* ── Send Email & Download CV buttons ── */}
